...
class PlaidCategoryTest < MiniTest::Test
  ...
  def test_string_representation
    c = PlaidLegacy::Category.new('type' => 'place',
                                  'hierarchy' => ['Travel'],
                                  'id' => '22000000')
  ...
  def test_all_categories_with_custom_client
    client = PlaidLegacy::Client.new(env: 'https://example.com')

    stub_request(:get, 'https://example.com/categories')
      .to_return(status: 200, body: fixture(:categories))

    PlaidLegacy::Category.all(client: client)
  end
  ...
  def test_get_single_category
    ...
    cat = PlaidLegacy::Category.get '19012002'
    refute_nil cat
  ...
  def test_get_single_category_with_custom_client
    ...
    PlaidLegacy::Category.get '19012002', client: client
  end
